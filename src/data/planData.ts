...
export const STUDY_PLAN: DayPlan[] = [
  ...
  // Day 9: 17/8
  {
    ...
    tasks: [
      { id: 'd9-chem-1', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'الفصل الخامس — كلاميات (كامل)' },
      { id: 'd9-chem-2', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'الفصل الخامس — مسائل (كامل)' },
  ...
  // Day 10: 18/8
  {
    ...
    tasks: [
      { id: 'd10-chem-1', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'الفصل السادس — كلاميات (الجزء الأول)' },
      { id: 'd10-chem-2', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'الفصل السادس — مسائل (الجزء الأول)' },
  ...
  // Day 11: 19/8
  {
    ...
    tasks: [
      { id: 'd11-chem-1', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'الفصل السادس — كلاميات (الجزء الثاني والختام)' },
      { id: 'd11-chem-2', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'الفصل السادس — مسائل (الجزء الثاني والختام)' },
  ...
  // Day 12: 20/8
  {
    ...
    tasks: [
      { id: 'd12-chem-1', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'الفصل السابع — كلاميات (كامل)' },
      { id: 'd12-chem-2', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'الفصل السابع — مسائل (كامل)' },
  ...
  // Day 13: 21/8
  {
    ...
    tasks: [
      { id: 'd13-chem-1', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'وزاريات الفصل الأول — كلاميات' },
      { id: 'd13-chem-2', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'وزاريات الفصل الأول — مسائل' },
  ...
  // Day 14: 22/8
  {
    ...
    tasks: [
      { id: 'd14-chem-1', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'وزاريات الفصل الثاني — كلاميات' },
      { id: 'd14-chem-2', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'وزاريات الفصل الثاني — مسائل' },
  ...
  // Day 15: 23/8
  {
    ...
    tasks: [
      { id: 'd15-chem-1', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'وزاريات الفصل الثالث — كلاميات' },
      { id: 'd15-chem-2', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'وزاريات الفصل الثالث — مسائل' },
  ...
  // Day 16: 24/8
  {
    ...
    tasks: [
      { id: 'd16-chem-1', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'وزاريات الفصل الرابع — كلاميات' },
      { id: 'd16-chem-2', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'وزاريات الفصل الرابع — مسائل' },
  ...
  // Day 17: 25/8
  {
    ...
    tasks: [
      { id: 'd17-chem-1', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'وزاريات الفصل الخامس — كلاميات' },
      { id: 'd17-chem-2', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'وزاريات الفصل الخامس — مسائل' },
  ...
  // Day 18: 26/8
  {
    ...
    tasks: [
      { id: 'd18-chem-1', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'وزاريات الفصل السادس — كلاميات' },
      { id: 'd18-chem-2', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'وزاريات الفصل السادس — مسائل' },
  ...
  // Day 19: 27/8
  {
    ...
    tasks: [
      { id: 'd19-chem-1', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'وزاريات الفصل السابع — كلاميات' },
      { id: 'd19-chem-2', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'وزاريات الفصل السابع — مسائل' },
  ...
  // Day 20: 28/8
  {
    ...
    tasks: [
      { id: 'd20-chem-1', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'مراجعة كلاميات الكيمياء الشاملة + وزاريات' },
      { id: 'd20-chem-2', subjectId: 'chemistry', subjectName: 'الكيمياء', title: 'مراجعة مسائل الكيمياء الشاملة + وزاريات' },
