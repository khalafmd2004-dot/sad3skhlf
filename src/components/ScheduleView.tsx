  ...
  return (
    <div className="space-y-4 pb-20">
      <div className="flex items-center justify-between bg-slate-900/80 p-4 rounded-2xl border border-slate-800">
        <div>
          <h2 className="text-lg font-black text-slate-100">الجدول الوزاري الشامل</h2>
          <p className="text-xs text-slate-400 mt-0.5">من 10/8 إلى 28/8 — اضغط على أي يوم لعرض مهامه التفصيلية</p>
        </div>
      </div>
